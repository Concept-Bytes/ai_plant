...
REPO_URL="https://github.com/conlan0/ai_plant.git"
INSTALL_DIR="/opt/ai_plant"
SERVICE_USER="aiplantuser"
...
cat <<EOF | sudo tee /etc/systemd/system/ai_plant.service
[Unit]
Description=AI Plant Monitoring Service
...
ExecStart=$INSTALL_DIR/venv/bin/python plant.py
Restart=always
...
sudo systemctl enable ai_plant.service
sudo systemctl start ai_plant.service

echo "AI Plant application installation and service setup completed successfully."
